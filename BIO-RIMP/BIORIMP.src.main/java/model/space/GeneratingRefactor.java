...
public abstract class GeneratingRefactor {
    ...
    public abstract OBSERVRefactoring generatingRefactor();

    public abstract boolean feasibleRefactor(RefactoringOperation ref );

    public abstract OBSERVRefactoring repairRefactor(RefactoringOperation ref, int break_point);
