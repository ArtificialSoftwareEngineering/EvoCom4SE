...
public class RefOperDelGen extends ArityOne<List<RefactoringOperation>> {
  ...
  public RefOperDelGen(int gene_size, int min_length, int max_length, MetaphorCode metaphor) {
  ...
  public RefOperDelGen(int gene_size, int min_length, int max_length, 
		  boolean del_last_gene, MetaphorCode metaphor) {
  ...
  public static void main(String[] argv){
	  ...
	  RefOperDelGen del = new RefOperDelGen(5, 5, 20, false, metaphor);
